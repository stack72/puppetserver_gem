...
Puppet::Type.type(:package).provide :puppetserver_gem, :parent => :gem do
  desc "PuppetServer Ruby Gem support. If a URL is passed via `source`, then
    ...
    repositories. PLEASE NOTE: This is a direct clone of the PE specific
    provider so that it works for FOSS Puppet"

  has_feature :versionable

  commands :puppetservercmd => "/usr/bin/puppetserver"
